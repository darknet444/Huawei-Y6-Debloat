...
adb shell pm uninstall --user 0 com.android.galaxy4
...
adb shell pm uninstall --user 0 com.factory.factoryservice
...
adb shell pm uninstall --user 0 com.huawei.android.temperaturemonitor
...
adb shell pm uninstall --user 0 com.huawei.hwvplayer
...
adb shell pm uninstall --user 0 com.nuance.swype.emui
adb shell pm uninstall --user 0 com.qeexo.smartshot
adb shell pm uninstall --user 0 com.runtastic.android.results.lite
adb shell pm uninstall --user 0 org.simalliance.openmobileapi.service
adb shell pm uninstall --user 0 se.dirac.acs
#adb shell pm uninstall --user 0 com.huawei.android.launcher #Default HuaweiLauncher
#adb shell pm uninstall --user 0 com.google.android.inputmethod.latin #Google Keyboard
#adb shell pm uninstall --user 0 com.huawei.systemmanager #Huawei System Cleaner
